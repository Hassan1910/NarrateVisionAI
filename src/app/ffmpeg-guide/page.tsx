  ...
  return (
    <div className="min-h-screen font-[family-name:var(--font-geist-sans)] dark">
      ...
      <main className="max-w-4xl mx-auto px-4 py-8">
        ...
        <div className="bg-indigo-50 dark:bg-indigo-900/20 border-l-4 border-indigo-500 p-4 mb-8">
          <div className="flex">
            <div className="flex-shrink-0">
            ...
            <div className="ml-3">
              <h3 className="text-sm font-semibold text-indigo-700 dark:text-indigo-300 mb-1">
                About FFmpeg in Vercel Deployment
              </h3>
              <p className="text-sm text-indigo-700 dark:text-indigo-300">
                When running NarrateVision on Vercel, FFmpeg is not available due to serverless environment limitations. The application will automatically use fallback mechanisms to generate videos. For the full experience with all video features and highest quality, we recommend running the application locally with FFmpeg installed.
              </p>
            </div>
          </div>
        </div>

    ...
    <button
      ...
      className={`p-2 sm:p-2.5 rounded-full shadow-sm ${
        isListening
          ...
          : 'bg-gradient-to-r from-indigo-500 to-violet-500 text-white hover:from-indigo-600 hover:to-violet-600 hover:shadow-md active:from-indigo-700 active:to-violet-700'
      } transition-all duration-200 focus:outline-none focus:ring-2 focus:ring-indigo-500 transform hover:-translate-y-0.5 active:translate-y-0 ${className}`}
    ...
    >
      {isListening ? (
        ...
        <div className="relative">
          ...
          <span className="absolute -top-1 -right-1 h-1.5 w-1.5 sm:h-2 sm:w-2 rounded-full bg-red-300 animate-ping"></span>
        </div>
      ) : (
